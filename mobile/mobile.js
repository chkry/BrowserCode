if (!window.PalmSystem) {
    ...
    var responseSet = [
        ...
        "luna://com.webos.settingsservice/getSystemSettings", "./watch/returns/getSafetyCareStatus.json",
        "luna://com.webos.settingsservice/getSystemSettings", "./watch/returns/getSafetyCareNumber.json",
        "luna://com.webos.settingsservice/getSystemSettings", "./watch/returns/getSafetyCareName.json",
        "luna://com.webos.settingsservice/getSystemSettings", "./watch/returns/getEulaStatus.json",
        "luna://com.webos.settingsservice/setSystemSettings", "./watch/returns/saveSafetyCareStatus.json",
        "luna://com.webos.settingsservice/setSystemSettings", "./watch/returns/saveContactDetailsInDB.json",
        "luna://com.webos.settingsservice/setSystemSettings", "./watch/returns/saveSafetycareStatus.json",
