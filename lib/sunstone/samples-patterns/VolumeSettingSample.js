enyo.kind({
	...
	spinner: 0,
	components: [
		{kind: "sun.Header",title:"Setting", showBackButton:true, onBackButtonTapped:"buttonTapped"},
		...
		{classes: "volume-table", ontap: "showPopup", popup: "volumePopup", components: [
			{classes:"volume-table-cell", components: [
				{kind: "sun.IconButton", classes: "iconButtonSample_custom", src: "./assets/btn_actionitem_icon_volume.svg"}
			]},
			{classes:"volume-table-cell", components: [
				{content: "set volume"}
			]}
		...
		{classes: "volume-table", ontap: "showPopup", popup: "delete1Popup", components: [
			{classes:"volume-table-cell", components: [
				{kind: "sun.IconButton", classes: "iconButtonSample_custom", src: "./assets/btn_actionitem_icon_delete.svg"}
			]},
			{classes:"volume-table-cell", components: [
		...
		{name: "volumePopup", kind: "sun.Popup", classes: "sun-sample-popup enyo-unselectable", centered: true, components: [
			...
			{kind: "FittableColumns", style: "padding: 0 24px; height: 40px",components:[
				{style: "width:40px;height:40px;", components: [
					{kind: "sun.Icon", classes: "iconButtonSample_custom", src: "./assets/btn_actionitem_icon_volume.svg"}
				]},
				{fit: true, style:"padding: 0 16px 0 4px;", components: [
					{name: "Rington", kind: "sun.Slider", value: 80, onChanging: "sliderChanging", onChange: "sliderChanged"}
				]}
			]},
			{content: "Notification", classes: "text-style"},
			{kind: "FittableColumns", style: "padding: 0 24px; height: 40px",components:[
				{style: "width:40px;height:40px;", components: [
					{kind: "sun.Icon", classes: "iconButtonSample_custom", src: "./assets/btn_actionitem_icon_calendar.svg"}
				]},
				{fit: true, style:"padding: 0 16px 0 4px;", components: [
					{name: "Notification", kind: "sun.Slider", value: 20, onChanging: "sliderChanging", onChange: "sliderChanged"}
				]}
			]},
			{content: "Touch feedback & System", classes: "text-style"},
			{kind: "FittableColumns", style: "padding: 0 24px; height: 40px",components:[
				{style: "width:40px;height:40px;", components: [
					{kind: "sun.Icon", classes: "iconButtonSample_custom", src: "./assets/btn_actionitem_icon_edit.svg"}
				]},
				{fit: true, style:"padding: 0 16px 0 4px;", components: [
					{name: "Touch", kind: "sun.Slider", value: 50, onChanging: "sliderChanging", onChange: "sliderChanged"}
				]}
			]},
			{content: "Music, Video, Games & other Media", classes: "text-style"},
			{kind: "FittableColumns", style: "padding: 0 24px; height: 40px",components:[
				{style: "width:40px;height:40px;", components: [
					{kind: "sun.Icon", classes: "iconButtonSample_custom", src: "./assets/btn_actionitem_icon_more.svg"}
				]},
				{fit: true, style:"padding: 0 16px 0 4px;", components: [
					{name: "Music", kind: "sun.Slider", value: 70, onChanging: "sliderChanging", onChange: "sliderChanged"}
				]}
			]},
		...
		{name: "delete1Popup", kind: "sun.Popup", classes: "sun-sample-popup", centered: true, components: [
			...
			{name: "deleteProgress", kind: "sun.ProgressBar", progress: 0, style:"margin:20px 36px 16px 36px"},
			{classes: "command_buttons_wrapper", components: [
				{classes: "command_buttons", components: [
					{kind: "sun.Button", content: "CANCEL", classes: "bottom-okcancle-button", ontap: "hidePopups"}
				]}
		...
		{name: "delete2Popup", kind: "sun.Popup", classes: "sun-sample-popup", centered: true, components: [
