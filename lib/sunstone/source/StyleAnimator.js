/**
* @typedef {Object} sun.StyleAnimator~[AnimationDefinitionObject]{@link sun.StyleAnimator~AnimationDefinitionObject}
* @property {String} name - A name for the animation. If unspecified, a name will be generated.
* This property is optional.
* @property {Number} duration - Animation duration, in milliseconds. If unspecified, the default duration will be used.
* This property is optional.
* @property {Object} timingFunction - If not specified, the
* [timingFunction]{@link http://enyojs.com/docs/latest/api.html#enyo.StyleAnimator::defaultTimingFunction} will be used.
* This property is optional.
...
/**
* Fired when an animation step occurs.
*
* @event sun.StyleAnimator#onStep
* @type {Object}
...
*
* @event sun.StyleAnimator#onComplete
* @type {Object}
...
/**
* _sun.StyleAnimator_ is a basic animation component. Call [play()]{@link sun.StyleAnimator#play} to start the animation.
* The animation will run for the period of time (in milliseconds) specified by its duration,
* subject to its [timingFunction]{@link sun.StyleAnimator# AnimationDefinitionObject} and
* [direction]{@link sun.StyleAnimator# AnimationDefinitionObject}.
*
* @class sun.StyleAnimator
* @extends enyo.Component
* @private
*/

enyo.kind(
	/** @lends sun.StyleAnimator.prototype */ {

	/**
	* @private
	*/
	name: "sun.StyleAnimator",
	...
	*/
	...
	/**
	* Creates an animation object with the given properties, adds the object in the
	* `animations` array and returns the created animation object.
	*
	* @param {object} inProps - Contains properties of an animation object.
	* @returns {object} The created animation object.
	* @private
	*/
	...
	*
	* @param {String} inName - Name of the animation to reset properties..
	* @private
	*/
	...
	/**
	* Plays the given animation according to its properties.
	*
	* @param {String} inName - Name of the animation to play.
	* @private
	*/
	...
	/**
	* Jumps directly to the end state of the given animation, without animation.
	*
	* @param {String} name - Name of the animation to jump to the end to.
	* @private
	*/
	...
	*
	* @param {String} inName - Name of the animation to pause.
	* @private
	*/
	...
	/**
	* Gets the animation with the given name from the `animations` array.
	*
	* @param {String} inName - Name of the animation.
	* @returns {object} Animation with the given name.
	* @private
	*/
	...
	/**
	* Removes the existing animation from the `animations` array, stopping it first, if necessary.
	*
	* @param {String} name - Name of the animation to delete.
	* @private
	*/
