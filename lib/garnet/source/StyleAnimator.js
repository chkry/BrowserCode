(function (enyo, g, scope) {
	...
	*/
	...
	/**
	* _g.StyleAnimator_ is a basic animation component.  Call [play()]{@link enyo.StyleAnimator#play} to start the animation.
	* The animation will run for 	* the period of time (in milliseconds) specified by its `duration`, subject to its
	* `timingFunction` and `direction` (See: {@link g.StyleAnimator~AnimationDefinitionObject}).
	*
