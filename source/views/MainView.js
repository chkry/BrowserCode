/**
 * @fileOverView: MainView - Wrapper view for the Safetycare application
 * @author: CSP1(Web App Development)
 * @version: v0.1.0
 * @createdDate: 10-02-2014
 * @modifiedDate: 17-03-2014
 */
enyo.kind({
	name: "Safetycare.MainView",
	classes: "app-container enyo-unselectable",
	components: [
		{kind: "Safetycare.SafetycareMainView", id: "homeView"}
	]
});
